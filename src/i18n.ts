...
const translations: Record<LangCode, Dict> = {
  'pt-BR': {
    ...
    'modal.pwa.ios.s1':       'Abra esta página no Safari',
    ...
    'modal.pwa.android.s1':   'Abra esta página no Chrome',
    'modal.pwa.android.s2':   'Toque no menu (⋮) no canto superior',
    'modal.pwa.android.s3':   'Toque em «Adicionar à tela inicial»',
    'modal.pwa.android.s4':   'Toque em «Instalar»',
  ...
  'pt-PT': {
    ...
    'modal.pwa.ios.hint':     'Siga os passos no Safari:',
    'modal.pwa.android.hint': 'Siga os passos no Chrome:',
    'modal.pwa.ios.s1':       'Abre esta página no Safari',
    ...
    'modal.pwa.android.s1':   'Abre esta página no Chrome',
    'modal.pwa.android.s2':   'Toca no menu (⋮) no canto superior',
    'modal.pwa.android.s3':   'Toca em «Adicionar ao ecrã inicial»',
    'modal.pwa.android.s4':   'Toca em «Instalar»',
    'modal.pwa.android.btn':  'Instalar agora',
  ...
  'en': {
    ...
    'modal.pwa.ios.s1':       'Open this page in Safari',
    'modal.pwa.ios.s2':       'Tap the Share button (□↑)',
    'modal.pwa.ios.s3':       'Tap «Add to Home Screen»',
    'modal.pwa.ios.s4':       'Confirm by tapping «Add»',
    'modal.pwa.android.s1':   'Open this page in Chrome',
    'modal.pwa.android.s2':   'Tap the menu (⋮) in the top corner',
    'modal.pwa.android.s3':   'Tap «Add to Home Screen»',
    'modal.pwa.android.s4':   'Tap «Install»',
  ...
  'es': {
    ...
    'modal.pwa.ios.s1':       'Abre esta página en Safari',
    ...
    'modal.pwa.android.s1':   'Abre esta página en Chrome',
    'modal.pwa.android.s2':   'Toca el menú (⋮) en la esquina superior',
    'modal.pwa.android.s3':   'Toca «Añadir a pantalla de inicio»',
    'modal.pwa.android.s4':   'Toca «Instalar»',
  ...
  'fr': {
    ...
    'modal.pwa.ios.s1':       'Ouvrez cette page dans Safari',
    ...
    'modal.pwa.android.s1':   'Ouvrez cette page dans Chrome',
    'modal.pwa.android.s2':   'Appuyez sur le menu (⋮) en haut',
    'modal.pwa.android.s3':   'Appuyez sur «Ajouter à l\'écran d\'accueil»',
    'modal.pwa.android.s4':   'Appuyez sur «Installer»',
  ...
  'de': {
    ...
    'modal.pwa.ios.s1':       'Öffne diese Seite in Safari',
    'modal.pwa.ios.s2':       'Tippe auf Teilen (□↑)',
    'modal.pwa.ios.s3':       'Tippe auf «Zum Home-Bildschirm»',
    'modal.pwa.ios.s4':       'Bestätige mit «Hinzufügen»',
    'modal.pwa.android.s1':   'Öffne diese Seite in Chrome',
    'modal.pwa.android.s2':   'Tippe auf das Menü (⋮) oben rechts',
    'modal.pwa.android.s3':   'Tippe auf «Zum Startbildschirm hinzufügen»',
    'modal.pwa.android.s4':   'Tippe auf «Installieren»',
  ...
  'it': {
    ...
    'modal.pwa.ios.s1':       'Apri questa pagina in Safari',
    ...
    'modal.pwa.android.s1':   'Apri questa pagina in Chrome',
    'modal.pwa.android.s2':   'Tocca il menu (⋮) in alto',
    'modal.pwa.android.s3':   'Tocca «Aggiungi alla schermata Home»',
    'modal.pwa.android.s4':   'Tocca «Installa»',
  ...
  'ja': {
    ...
    'modal.pwa.ios.s1':       'SafariでこのページをSafariで開く',
    'modal.pwa.ios.s2':       '共有ボタン（□↑）をタップ',
    'modal.pwa.ios.s3':       '「ホーム画面に追加」をタップ',
    'modal.pwa.ios.s4':       '「追加」をタップして確認',
    'modal.pwa.android.s1':   'ChromeでこのページをChromeで開く',
    'modal.pwa.android.s2':   '右上のメニュー（⋮）をタップ',
    'modal.pwa.android.s3':   '「ホーム画面に追加」をタップ',
    'modal.pwa.android.s4':   '「インストール」をタップ',
  ...
  'ko': {
    ...
    'modal.pwa.ios.s1':       'Safari에서 이 페이지 열기',
    'modal.pwa.ios.s2':       '공유 버튼(□↑) 탭하기',
    'modal.pwa.ios.s3':       '«홈 화면에 추가» 탭하기',
    'modal.pwa.ios.s4':       '«추가»를 탭하여 확인',
    'modal.pwa.android.s1':   'Chrome에서 이 페이지 열기',
    'modal.pwa.android.s2':   '오른쪽 상단 메뉴(⋮) 탭하기',
    'modal.pwa.android.s3':   '«홈 화면에 추가» 탭하기',
    'modal.pwa.android.s4':   '«설치» 탭하기',
  ...
  'zh-CN': {
    ...
    'modal.pwa.ios.s1':       '在 Safari 中打开此页面',
    'modal.pwa.ios.s2':       '点击分享按钮（□↑）',
    'modal.pwa.ios.s3':       '点击「添加到主屏幕」',
    'modal.pwa.ios.s4':       '点击「添加」确认',
    'modal.pwa.android.s1':   '在 Chrome 中打开此页面',
    'modal.pwa.android.s2':   '点击右上角菜单（⋮）',
    'modal.pwa.android.s3':   '点击「添加到主屏幕」',
    'modal.pwa.android.s4':   '点击「安装」',
